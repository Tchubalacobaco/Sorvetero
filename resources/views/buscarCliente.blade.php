...
<div class="container m-4">
  <form method="get" action="{{route('todos-cliente')}}">
...
<table class="table">
  ...
  <tbody>
    @foreach($cliente as $clienteArray)
    <tr>
      <th scope="row">{{$clienteArray->id}}</th>
      <td>{{$clienteArray->nomeCliente}}</td>
      <td>{{$clienteArray->foneCliente}}</td>
      <td>{{$clienteArray->cepCliente}}</td>
      <td>{{$clienteArray->cpfCliente}}</td>
      <td>
        <a href="{{route('alterar-cliente',$clienteArray->id)}}">
  ...
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1z"/>
      ...
      <td>
        <form method="POST" action="{{route('delete-cliente',$clienteArray->id)}}">
          @method('delete')
          @csrf
